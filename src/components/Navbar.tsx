...
export default function Navbar() {
  ...
  return (
    ...
    >
      <nav className="flex items-center gap-1 sm:gap-2 rounded-full border border-border bg-surface/50 px-2 py-2 backdrop-blur-2xl shadow-glass">
        {SECTIONS.map((s) => {
          ...
          return (
            <button
              ...
              className="group relative rounded-full px-4 py-2 text-sm font-medium transition-colors outline-none"
            >
